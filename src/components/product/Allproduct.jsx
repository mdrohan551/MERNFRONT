                ...
                <div className="col-md-3 p-2">
                    <div className="card vh-100 p-3 shadow-sm">
                        ...
                        <select value={filter.brandID} onChange={async (e) => {
                            await inputOneChange("brandID", e.target.value)
                        ...
                        <select value={filter.categoryID} onChange={async (e) => {
                            await inputOneChange("categoryID", e.target.value)
                        }} className="form-control form-select">
                        ...
                        <input value={filter.priceMax} onChange={async (e) => {
                            await inputOneChange("priceMax", e.target.value)
                        }} type="range" min={70} max={1000000} step={1000} className="form-range"/>
                        <label className="form-label mt-3"> Minimun Price ${filter.priceMin}</label>
                        <input value={filter.priceMin} onChange={async (e) => {
                            await inputOneChange("priceMin", e.target.value)
                        }} type="range" min={70} max={1000000} step={1000} className="form-range"/>
                    </div>
                </div>
